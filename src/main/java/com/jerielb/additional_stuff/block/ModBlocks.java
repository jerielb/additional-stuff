...
public class ModBlocks {
	 ...
	 *
	 *  /assets/additional_stuff/lang/en_us.json
	 *      --> to put a proper name to the item
	 *
	 *  /assets/additional_stuff/models/blockstates/*.json
	 *      --> "variants" - states of the block ("" means no other states)
	 *      --> "model" - location of the model of the block in /assets/models/block/*
	 *
	 *  /assets/additional_stuff/models/block/*.json
	 *      --> "parent" - how the block would be generated
	 *      --> "textures"/"all" - the location of the items texture in /assets/additional_stuff/textures/block directory
	 *
	 *  /assets/additional_stuff/models/item/*.json
	 *      --> "parent" - redirect to the .../models/block/*.json set above
	 *
	 *  /assets/additional_stuff/textures/block/*.png
